                    ...
                    <div id="sidebar-menu">
                        <ul>
							...
							if($coinflip==1)
							{
								...
								echo'
								<li class="has_sub">
                                <a href="coinflip.php" class="waves-effect waves-light '.$cfd.'"><i class="fa fa-circle-o" aria-hidden="true"></i><span>CoinFlip </span> </a>
								<ul class="list-unstyled" '.$cfc.'>
									<li><a href="coinflip.php">Play!</a></li>
							...
							?>
                            <li class="has_sub">
                                <a href="#" class="waves-effect <?php if($page=="j1"){echo'subdrop';} ?>"><i class="ti-home"></i><span>Jackpot 1 </span> </a>
                            ...
                            <li class="has_sub">
                                <a href="#" class="waves-effect <?php if($page=="j2"){echo'subdrop';} ?>"><i class="ti-home"></i><span>Jackpot 2 </span> </a>
