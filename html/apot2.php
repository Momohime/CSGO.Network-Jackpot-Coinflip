                    	...
                    	<div class="row">
		                    <div class="col-lg-12">
		                    	<div class="widget-bg-color-icon card-box">
		                    		<h1>Pot 2 Settings</h1>
									<br>
									<?php
									$maxritem = fetchinfo("value","p2info","name","maxritem");	
									$minbet = fetchinfo("value","p2info","name","minbet");
									$maxbet = fetchinfo("value","p2info","name","maxbet");									
									$maxitems = fetchinfo("value","p2info","name","maxitems");	
									$rake = fetchinfo("value","p2info","name","rake");
									$prake = fetchinfo("value","p2info","name","prake");
									$srake = fetchinfo("value","p2info","name","srake");
									...
									<form class="form-inline" method="post" action="updatemri.php">
										<div class="form-group">
											<input type="text" class="form-control" id="mri2" name="mri2" placeholder="Max Skins / Game" value="'.$maxritem.'">
										</div>
									...
									<form class="form-inline" method="post" action="updateminb.php">
										<div class="form-group">
											<input type="text" class="form-control" id="mb2" name="mb2" placeholder="Minimum Bet ($)" value="'.$minbet.'">
										</div>
										<button value="submit" name="submit" id="submit" type="submit" class="btn btn-purple waves-effect waves-light m-l-10 btn-md">Modify</button>
									</form>
									...
									<form class="form-inline" method="post" action="updatemaxb.php">
										<div class="form-group">
											<input type="text" class="form-control" id="mb2" name="mb2" placeholder="Maximum Bet ($)" value="'.$maxbet.'">
										</div>
										<button value="submit" name="submit" id="submit" type="submit" class="btn btn-purple waves-effect waves-light m-l-10 btn-md">Modify</button>
									</form>
									...
									<form class="form-inline" method="post" action="updatems.php">
										<div class="form-group">
											<input type="text" class="form-control" id="ms2" name="ms2" placeholder="Maximum Skins / Round" value="'.$maxitems.'">
										</div>
										<button value="submit" name="submit" id="submit" type="submit" class="btn btn-purple waves-effect waves-light m-l-10 btn-md">Modify</button>
									</form>
									...
									<form class="form-inline" method="post" action="updaterake.php">
										<div class="form-group">
											<input type="text" class="form-control" id="rk2" name="rk2" placeholder="Rake (%)" value="'.$rake.'">
										</div>
										<button value="submit" name="submit" id="submit" type="submit" class="btn btn-purple waves-effect waves-light m-l-10 btn-md">Modify</button>
									</form>
									...
									<form class="form-inline" method="post" action="updatesrake.php">
										<div class="form-group">
											<input type="text" class="form-control" id="srk2" name="srk2" placeholder="Sponsor Rake (%)" value="'.$srake.'">
										</div>
										<button value="submit" name="submit" id="submit" type="submit" class="btn btn-purple waves-effect waves-light m-l-10 btn-md">Modify</button>
									</form>
									...
									<form class="form-inline" method="post" action="updateprake.php">
										<div class="form-group">
											<input type="text" class="form-control" id="prk2" name="prk2" placeholder="Premium Rake (%)" value="'.$prake.'">
										</div>
										<button value="submit" name="submit" id="submit" type="submit" class="btn btn-purple waves-effect waves-light m-l-10 btn-md">Modify</button>
									</form>
