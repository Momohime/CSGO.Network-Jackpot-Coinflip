                    	...
                    	<div class="row">
		                    <div class="col-lg-12">
		                    	<div class="widget-bg-color-icon card-box">
		                    		<h1>Trade URL</h1>
									<p>
									<a href="http://steamcommunity.com/id/me/tradeoffers/privacy#trade_offer_access_url" target="_BLANK">You can find your Trade URL here!</a>
									<br>
									<a href="http://steamcommunity.com/id/me/edit/settings" target="_BLANK">Don't forget to make your Inventory & Profile public!</a>
									</p>
		                    	...
		                    	<div class="widget-bg-color-icon card-box">
		                    		...
		                    		<form method="POST" class="form-horizontal group-border-dashed" action="updateemail.php" novalidate="">
												<div class="form-group">
	                                                ...
	                                                <div class="col-sm-6">
	                                                    <input type="email" name="link" id="link" name="example-email" class="form-control" value='<?php if(!empty($email)) echo $email; ?>' placeholder="Enter a valid Email adress">
	                                                </div>
	                                            </div>
												<div class="form-group">
													<div class="col-sm-12">
