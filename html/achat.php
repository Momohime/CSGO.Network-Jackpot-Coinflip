                    	...
                    	<div class="row">
		                    <div class="col-lg-12">
		                    	<div class="widget-bg-color-icon card-box">
									...
									<u>Normal Spam Delay - Normal users can send a chat message every X seconds</u><br><br>
									
									<form class="form-inline" method="post" action="updatenspam.php">
										<div class="form-group">
											<input type="text" class="form-control" id="nm" name="nm" placeholder="Normal Spam Delay" value="'.$nmsg.'">
										</div>
									...
									<u>Premium Spam Delay - Premium users can send a chat message every X seconds</u><br><br>
									<form class="form-inline" method="post" action="updatepspam.php">
										<div class="form-group">
											<input type="text" class="form-control" id="pm" name="pm" placeholder="Premium Spam Delay" value="'.$pmsg.'">
										</div>
										<button value="submit" name="submit" id="submit" type="submit" class="btn btn-purple waves-effect waves-light m-l-10 btn-md">Modify</button>
									</form>
